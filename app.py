...
_SECTOR_ICONS = {
    ...
    "Insurance":                        "🛡️",
    "Investment":                       "💼",
    "Investment Services":              "🏛️",
    "Manufacturing and Allied":         "🏭",
    "Real Estate Investment Trust":     "🏠",
    "Telecommunication and Technology": "📱",
}
# (ticker_short, name, NSE sector) — verified against nse.co.ke/listed-companies/ (2026-07-28)
_RAW_COMPANIES = [
    ("ABSA", "Absa Bank Kenya",              "Banking"),
    ("ALP",  "ALP Industrial REIT",          "Real Estate Investment Trust"),
    ("AMAC", "Africa Mega Agricorp",         "Manufacturing and Allied"),
    ("BAT",  "BAT Kenya",                    "Manufacturing and Allied"),
    ("BKG",  "BK Group",                     "Banking"),
    ("BOC",  "BOC Kenya",                    "Manufacturing and Allied"),
    ("BRIT", "Britam Holdings",              "Insurance"),
    ("CARB", "Carbacid Investments",         "Manufacturing and Allied"),
    ("CGEN", "Car and General (K)",          "Automobiles and Accessories"),
    ...
    ("FTGH", "Flame Tree Group Holdings",    "Manufacturing and Allied"),
    ("GLD",  "New Gold Issuer (ETF)",        "Exchange Traded Funds"),
    ...
    ("KPC",  "Kenya Pipeline Company",       "Energy and Petroleum"),
    ("KPLC", "Kenya Power & Lighting",       "Energy and Petroleum"),
    ("KQ",   "Kenya Airways",               "Commercial and Services"),
    ...
    ("NBV",  "Nairobi Business Ventures",    "Commercial and Services"),
    ...
    ("SGL",  "Standard Group",               "Commercial and Services"),
    ("SHKL", "Shri Krishana Overseas",       "Manufacturing and Allied"),
    ("SLAM", "Sanlam Allianz Holdings",      "Insurance"),
    ("SMER", "Sameer Africa",               "Commercial and Services"),
    ("SMWF", "Satrix MSCI World Feeder ETF", "Exchange Traded Funds"),
    ("TOTL", "Total Kenya",                  "Energy and Petroleum"),
    ("TPSE", "TPS Eastern Africa (Serena)",  "Commercial and Services"),
    ("TRFC", "TRIFIC Green USD I-REIT",      "Real Estate Investment Trust"),
    ("UCHM", "Uchumi Supermarket",           "Commercial and Services"),
    ("UMME", "Umeme",                        "Energy and Petroleum"),
